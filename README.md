#LNA with onboard Bias tee designed for use with RTL SDR dongles. LNA has two power options, USB mini or power from dongle. There is also option for an on-board wideband bias tee and bandpass filter.
